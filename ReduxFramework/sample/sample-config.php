...
if (!function_exists('redux_init')) :
    function redux_init() {
        ...
        $args['display_name'] = 'XCommander Settings';//$theme->get('Name');
        ...
        */
        ...
        // Default: Options
        $args['menu_title'] = __('XCommander', 'redux-framework-demo');

        // Set a custom page title for the options page.
        // Default: Options
        $args['page_title'] = __('XCommander Options', 'redux-framework-demo');
